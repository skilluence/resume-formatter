...
OTHER:
- professional_title: a short title derived from the user's domain (e.g. domain "Software Engineering" → "Software Engineer"; "Data Science" → "Data Scientist"). 2-4 words max. Title case.
