...
const h1: CSSProperties = { fontFamily: tk.serif, fontSize: "30px", fontWeight: 500, color: tk.onSurface, margin: "0 0 10px" };
const sub: CSSProperties = { fontSize: "15px", color: tk.onSurfaceTertiary, margin: "0 0 26px", lineHeight: 1.55 };
